...
const Footer = () => (
  <section
    className={`${styles.flexCenter} ${styles.paddingY} flex-col px-5 md:px-10 border-gray dark:border-white border-t border-t-[#3F3E45] bg-gray-300 dark:bg-black relative z-10 w-full overflow-hidden`}
  >
