...
const Example = () => (
  <section className={`bg-gradient-to-t from-gray-200 to-transparent dark:from-gray-900 mt-10 items-center flex flex-col`}>
    <div className="flex-row px-10 mb-20 max-w-[1280px]">
      <h2 className={`${styles.heading2} ss:text-left text-center md:min-w-[820px] lg:min-w-[1250px] font-bold`}>
    ...
    <div className="border-t border-gray-400 bg-blue-50 dark:bg-gray-900 flex justify-center min-w-full">
      <div className="mt-10 mb-10 z-10 flex max-w-[1280px] sm:flex-row flex-col sm:items-start justify-center items-center w-full">
        {features.map((feature, index) => (
          <div key={index} className={`p-4 ${layout.feature} px-10 xs:px-5 ${index === 1 ? "sm:border-gray-400 sm:border-l sm:border-r" : ""}`}>
            <p className="sm:text-[16px] md:text-[18px] lg:text-[20px] text-black font-bold dark:text-white">{feature.title}</p>
