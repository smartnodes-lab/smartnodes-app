...
const MainHero = () => {
    return(
        <section className={styles.section}>
            <div className={`bg-white dark:bg-gray-700 shadow-xl items-center rounded-xl mt-20 ${styles.content}`}>
                <div className={`${styles.contentBox} flex-row mt-2 mb-2`}>
                <div className="z-0 w-[58%] h-[25%] absolute rounded-full dark:white__gradient black__gradient left-20"></div>
                    <div className="min-w-[350px] mr-10 hidden md:block">
                    ...
                    <div className="z-20 max-w-xl justify-center items-center">
                        <div className="sm:mr-10 py-10 justify-items-center">
                            <h2 className="text-[36px] md:text-[42px] font-bold text-gray-800 dark:text-gray-200 mb-4">Empowering Individuals.</h2>
