...
const Testimonials = () => (
  <section id="tools" className={`${styles.flexCenter} flex-col px-5`}>
    ...
    <div className={`w-full px-10 z-20`}>
      <div className="items-center rounded-2xl dark:bg-gray-900 bg-gray-200 px-10 py-5 sm:py-10">
        <div className="w-full flex flex-col sm:flex-row items-center">
          <h2 className={`${styles.heading2} font-extrabold text-[36px] mt-10 ml-10`}>
        ...
        <p className={`${styles.landingText} max-w-[1300px] p-8`}>
    ...
    {/* Feedback section */}
    <div className="w-full px-10 z-20 mt-5 md:mt-10">
      <div className={`flex flex-col md:flex-row justify-center items-center feedback-container relative sm:py-7 py-3 z-[1] dark:bg-gray-900 bg-gray-200 rounded-2xl`}>
