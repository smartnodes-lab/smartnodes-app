const styles = {
  ...
  landingText: "text-[15px] sm:text-[18px] md:text-[20px] lg:text-[22px] text-black dark:text-white leading-8",
  landingText2: "text-[14px] sm:text-[15px] md:text-[17px] lg:text-[21px] text-black dark:text-white leading-8"
};
